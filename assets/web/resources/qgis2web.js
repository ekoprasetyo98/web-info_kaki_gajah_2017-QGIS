...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [110.340981, -7.147905, 110.997918, -6.694570], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
            extent: [110.459053, -7.144269, 110.814629, -6.712522],
            units: 'degrees'})
    })
});
...
map.getView().fit([110.340981, -7.147905, 110.997918, -6.694570], map.getSize());
